...
//        StdOut.printf("a is noun? %b\n", wordNet.isNoun("a"));
//        StdOut.printf("b is noun? %b\n", wordNet.isNoun("b"));
//        StdOut.printf("distance is %d\n", wordNet.distance("c", "e"));
//        StdOut.printf("sap are %s\n", wordNet.sap("c", "e"));
        while (!StdIn.isEmpty()) {
            String n1 = StdIn.readString();
            String n2 = StdIn.readString();
            int length = wordNet.distance(n1, n2);
            String ancestor = wordNet.sap(n1, n2);
